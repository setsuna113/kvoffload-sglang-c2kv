        ...
        if (
            ...
            for idx, (extend_logprob_start_len, extend_len) in enumerate(
                ...
                if aux_pruned_states_lists is not None:
                    for states, chunks in zip(aux_hidden_states, aux_pruned_states_lists):
                        chunks.append(states[pt + start_len : pt + extend_len])
            ...
            if aux_pruned_states_lists is not None:
                aux_pruned_states = [torch.cat(chunks) for chunks in aux_pruned_states_lists]
